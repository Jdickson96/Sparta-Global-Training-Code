...
namespace Methods_Tests
{
    public class TuplesTests
    {
        ...
        [Test]
        [TestCase(4, 16, 64, 2)]
        [Category("Regular Inputs")]
        public void GivenANumber_PowersRoot_ReturnsCorrectResult (
            int input, int square, int cube, double squareRoot)
        {
            ...
            Assert.That(answer.squareRoot, Is.EqualTo(squareRoot), "SquareRoot");
        }

        [Test]
        [Category("Out Of Range Input")]
        ...
        .With.Message.Contain("Input Number must not be negative"));
        }
    }
}